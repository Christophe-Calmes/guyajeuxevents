...
<div id="hiddenForm">
<form class="flex-colonne-form" action="<?=encodeRoutage(42)?>" method="post">
    ...
    <lable for="position">Position relative de la table noté de 0 à 99</lable>
    <input type="number" id="position" name="position" min="0" max="99"/>
    <label for="picture">Image d'illustration de la news ?</label>
    <input id="picture" type="file" name="pictureOfTable" accept="image/png, image/jpeg, image/webp"/>
