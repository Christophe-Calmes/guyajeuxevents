...
echo '<section><h1 class="subTitleSite">Administrer un événement archiver valide</h1>';
...
$parPage = 9;
$nbrEvents = $events->countEvent (1, 1);
$nbrPages = ceil($nbrEvents/$parPage);
$firstPage = ($currentPage * $parPage)-$parPage;
$events->adminEvents($firstPage, $parPage, 1, 1, $idNav, 35);
